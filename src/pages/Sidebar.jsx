...
import { FiMenu, FiX, FiUsers, FiFileText, FiCreditCard, FiGrid } from "react-icons/fi";
...
const Sidebar = ({ role }) => {
  ...
  return (
    <div className="flex">
      {/* Sidebar */}
      <div className={`fixed top-0 left-0 h-full bg-blue-700 text-white w-64 transition-transform 
                      ${isOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 md:w-72 p-4 shadow-lg`}>
